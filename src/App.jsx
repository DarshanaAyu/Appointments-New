    ...
    <div className="p-5">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-1">
          ...
          <div className="relative">
            <label htmlFor="jump-date-input" className="flex items-center justify-center rounded-full" style={{ width: 30, height: 30, border: `1px solid ${C.line}` }} aria-label="Jump to date">
              <Calendar size={14} color={C.forest} />
            </label>
            <input
              id="jump-date-input" type="date" value={dateKey}
